...
def ig_request(hash_id, variables, resolver, resolver_args = {}, cookies = {}, sleep_requests = 3, sleep_error = 10, reintentos = 3):
	has_next_page = True
...
def resolver_following(variables, data_resp, extra_args):
	...
	for node in data_resp["edges"]:
		...
		fichero = open(args.username + '.txt','a+')
